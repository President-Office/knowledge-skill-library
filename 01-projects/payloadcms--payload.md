...
| 核心包 | `packages/payload`，属于 [[Monorepo Package]] |
| Next 集成 | [[Next.js]] |
| 数据库适配 | [[mongodb]]、[[postgresql]]、[[sqlite]]、[[D1]]、[[Vercel Postgres]] 等 |
| API | [[REST]]、[[GraphQL]]、[[SDK]] |
| Admin UI | `packages/ui`、内置 [[Admin Panel]] / [[Admin App]] |
| 插件 | [[Form Builder]]、[[Import Export]]、[[多租户]]、[[Search]]、[[SEO]]、[[Stripe]]、[[MCP]] 等 |
| 存储 | [[Amazon S3]]、[[Azure Blob Storage]]、[[Google Cloud Storage]]、[[Cloudflare R2]]、[[Vercel Blob]]、[[UploadThing]] 等 |
...
- [[02-reading-notes/payloadcms--payload/README]]
- [[05-practice-labs/payloadcms--payload/local-setup]]
