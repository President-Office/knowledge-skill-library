...
| 层次 | 技术/概念 |
| --- | --- |
| 后端 | [[Spring Boot]]、[[Java]] / [[JDK]] |
| 持久层 | [[MyBatis Plus]]、[[dynamic-datasource]]、[[Druid]] |
| 权限 | [[Shiro]]、[[JWT]]、shiro-redis（基于 [[redis]]） |
| 微服务 | [[Spring Cloud]]、[[Spring Cloud Alibaba]]、[[Nacos]] |
| 报表/BI | [[JimuReport]]、[[JimuBI]] |
| 代码生成 | [[jeecg codegenerate]] |
| 前端 | [[Vue 3]]、[[Vite]]、[[Ant Design Vue]]、[[Pinia]]、[[Vue Router]] |
| AI/流程 | README 描述包含 AI 聊天、知识库、[[工作流]]编排、[[MCP]]插件、[[AI Skills]]；前端依赖含 [[AI Flow]] |
...
- [[02-reading-notes/jeecgboot--JeecgBoot/README]]
- [[05-practice-labs/jeecgboot--JeecgBoot/local-setup]]
